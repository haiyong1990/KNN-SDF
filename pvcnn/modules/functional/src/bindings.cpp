...
#include "interpolate/nn_devox.hpp"
...
PYBIND11_MODULE(_pvcnn_backend, m) {
  ...
  m.def("nn_devoxelize_forward", &nn_devoxelize_forward,
        "NN Devoxelization forward (CUDA)");
  m.def("nn_devoxelize_backward", &nn_devoxelize_backward,
        "NN Devoxelization backward (CUDA)");
